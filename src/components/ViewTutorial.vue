		...
		<figure>
			...
			<app-game-svg viewBox="0 0 40 14" class="small-font">
				...
				<g transform="translate(0, 10)">
					...
					<app-game-shape code="Z"	:pattern="3" transform="translate(4, 1)"/>
					<app-game-shape code="O"	:pattern="3" transform="translate(8, 1)"/>
					<app-game-shape code="L"	:pattern="3" transform="translate(11, 0.5)"/>
